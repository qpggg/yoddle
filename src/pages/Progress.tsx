              ...
              <Box sx={{ position: 'relative', zIndex: 1 }}>
                <Typography variant="h5" sx={{ 
                  ...
                  <Box sx={{
                    ...
                    height: '40px',
                    borderRadius: '50%',
                    background: `linear-gradient(135deg, ${productivityProgress.level_color || '#8B4513'} 0%, ${productivityProgress.level_color || '#8B4513'}DD 100%)`,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    boxShadow: `0 4px 16px ${productivityProgress.level_color || '#8B4513'}40`
                  }}>
                    <Typography variant="h6" sx={{ color: '#fff', fontWeight: 900 }}>
                      {productivityProgress.level_icon || '🌱'}
                    </Typography>
                  </Box>
                  Прогресс продуктивности: {productivityProgress.productivity_level || 'Новичок'}
                </Typography>
                ...
                <Box sx={{ mb: 3 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 700, color: '#8B0000' }}>
                      {productivityProgress.productivity_score?.toFixed(1) || '0.0'} / 10.0
                    </Typography>
                  </Box>
                  
                  <LinearProgress 
                    variant="determinate" 
                    value={productivityProgress.progress_percentage || 0} 
                    sx={{
                      height: 12,
                      borderRadius: 6,
                      backgroundColor: '#f0f0f0',
                      '& .MuiLinearProgress-bar': {
                        background: `linear-gradient(90deg, ${productivityProgress.level_color || '#8B0000'} 0%, ${productivityProgress.level_color || '#B22222'} 100%)`,
                        borderRadius: 6,
                        boxShadow: `0 2px 8px ${productivityProgress.level_color || '#8B0000'}40`
                      }
                    }}
                  />
                </Box>
                ...
                <Grid container spacing={3} sx={{ mt: 3 }}>
                  <Grid item xs={6} md={3}>
                    <Box sx={{ textAlign: 'center' }}>
                      <Typography variant="h6" sx={{ 
                        fontWeight: 800, 
                        color: productivityProgress.level_color || '#8B0000',
                        fontSize: '1.5rem'
                      }}>
                        {productivityProgress.xp_multiplier || 1.0}x
                      </Typography>
                  ...
                  <Grid item xs={6} md={3}>
                    <Box sx={{ textAlign: 'center' }}>
                      <Typography variant="h6" sx={{ 
                        ...
                        {productivityProgress.next_level || 'Специалист'}
                      </Typography>
                      <Typography variant="body2" sx={{ color: '#666', fontSize: '0.9rem' }}>
                        Следующий уровень
                      </Typography>
                  ...
                  <Grid item xs={6} md={3}>
                    <Box sx={{ textAlign: 'center' }}>
                      <Typography variant="h6" sx={{ 
                        ...
                        {productivityProgress.score_to_next_level || 2.2}
                      </Typography>
                      <Typography variant="body2" sx={{ color: '#666', fontSize: '0.9rem' }}>
                        Очков до уровня
                      </Typography>
                  ...
                  <Grid item xs={6} md={3}>
                    <Box sx={{ textAlign: 'center' }}>
                      <Typography variant="h6" sx={{ 
                        ...
                        {productivityProgress.progress_percentage || 0}%
                      </Typography>
                      <Typography variant="body2" sx={{ color: '#666', fontSize: '0.9rem' }}>
                        Прогресс
                      </Typography>
