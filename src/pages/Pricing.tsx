...
const subscriptionPlans = [
  {
    ...
    features: [
      'Бесплатное использование платформы и обслуживание, льготы оплачиваются отдельно',
  ...
  },
  {
    ...
    features: [
      '2 обязательные льготы в месяц на сотрудника, простая система оплаты',
  ...
  },
  {
    ...
    features: [
      'Модель yoddle-coin и гибкая система оплаты',
