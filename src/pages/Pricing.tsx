...
const subscriptionPlans = [
  {
    ...
    features: [
      'Доступ к базовым партнерам (до 50+ компаний)',
      'Базовые скидки для сотрудников до 10%',
      'Ежемесячный отчет по использованию',
      'Базовая техническая поддержка в рабочее время',
      'Простая аналитика использования'
    ],
    savings: 'Экономия до 2000₽ на сотрудника в месяц',
    className: 'economy'
  },
  {
    title: 'Комфорт',
    ...
    features: [
      'Расширенный список партнеров (150+ компаний)',
    ...
    savings: 'Экономия до 5000₽ на сотрудника в месяц',
    className: 'comfort',
    popular: true
  },
  {
    ...
    features: [
      'Полный доступ ко всем партнерам (300+ компаний)',
    ...
    savings: 'Экономия до 12000₽ на сотрудника в месяц',
    className: 'premium'
  }
];
